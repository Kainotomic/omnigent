...
//
// Upstream also exempted maintainers (by authorAssociation or .github/MAINTAINER).
// That exemption is removed here: every PR in this repo is authored by an org
// member, so keeping it meant the rule never applied to anyone. `skip-issue-check`
// remains the per-PR escape hatch.
...
const EFFECTIVE_FROM = "2026-09-14T00:00:00Z";
...
See [CONTRIBUTING.md](https://github.com/Kainotomic/omnigent/blob/main/CONTRIBUTING.md#every-pr-needs-an-issue) for the full policy.
